...
<div class="modal-header">
 ...
 <div class="modal-body">
     <form id="formCreateKategoriRegulasi" action="{{ url($kategoriRegulasiUrl . '/createData') }}" method="POST">
         @csrf
         ...
         <div class="form-group">
             ...
             <select class="form-control" id="fk_regulasi_dinamis" name="m_kategori_regulasi[fk_regulasi_dinamis]">
                 ...
                 @foreach($regulasiDinamis as $regulasi)
                     <option value="{{ $regulasi->regulasi_dinamis_id }}">{{ $regulasi->rd_judul_reg_dinamis }}</option>
                 @endforeach
             </select>
 ...
 <script>
     $(document).ready(function () {
         ...
         $('#btnSubmitForm').on('click', function() {
             ...
             const form = $('#formCreateKategoriRegulasi');

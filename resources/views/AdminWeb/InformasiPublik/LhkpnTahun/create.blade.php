...
<div class="modal-body">
  <form id="form-create-lhkpn" action="{{ url($kategoriTahunLHKPNUrl . '/createData') }}" method="POST"
    enctype="multipart/form-data">
    @csrf
    <div class="form-group">
      <label for="lhkpn_tahun">Tahun LHKPN <span class="text-danger">*</span></label>
      <input type="text" class="form-control" id="lhkpn_tahun" name="m_lhkpn[lhkpn_tahun]" maxlength="4"
        placeholder="Masukkan tahun LHKPN">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="lhkpn_judul_informasi" name="m_lhkpn[lhkpn_judul_informasi]"
        maxlength="255" placeholder="Masukkan judul informasi">
    ...
    <div class="form-group">
      ...
      <textarea id="peraturan_lhkpn" name="m_lhkpn[lhkpn_deskripsi_informasi]" class="form-control"></textarea>

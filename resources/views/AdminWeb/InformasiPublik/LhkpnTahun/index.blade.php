      ...
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ url('adminweb/informasipublik/lhkpn-tahun/addData') }}')" 
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.pagination a', function(e) {
        ...
        loadLHKPNData(page, search);
      });
    });
    
    function loadLHKPNData(page, search) {
      $.ajax({
        url: '{{ url("adminweb/informasipublik/lhkpn-tahun/getData") }}',
        type: 'GET',
        data: {
          page: page,
          search: search
    ...
    function reloadTable() {
      ...
      var search = $('#searchForm input[name="search"]').val();
      loadLHKPNData(currentPage, search);
    }
  </script>
@endpush
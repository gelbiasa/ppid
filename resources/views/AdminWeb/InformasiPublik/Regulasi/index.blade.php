  ...
  <div class="card card-outline card-primary">
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ url('adminweb/informasipublik/regulasi/addData') }}')" 
      ...
      <div class="card-body">
          ...
          <div class="col-md-6">
            <form id="searchForm" class="d-flex">
              <input type="text" name="search" class="form-control" 
                     placeholder="Cari judul atau sinopsis regulasi" 
                     value="{{ $search ?? '' }}">
        ...
        <div class="table-responsive" id="table-container">
          @include('AdminWeb.InformasiPublik.Regulasi.data')
        </div>
      </div>
  </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.pagination a', function(e) {
        ...
        loadRegulasiData(page, search);
      });
    });
    
    function loadRegulasiData(page, search) {
      $.ajax({
        url: '{{ url("adminweb/informasipublik/regulasi/getData") }}',
        type: 'GET',
        data: {
          page: page,
          search: search
    ...
    function reloadTable() {
      ...
      var search = $('#searchForm input[name="search"]').val();
      loadRegulasiData(currentPage, search);
    }
  </script>
@endpush
  ...
  <div class="card card-outline card-primary">
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ url('adminweb/informasipublik/regulasi-dinamis/addData') }}')" 
      ...
      <div class="card-body">
          ...
          <div class="col-md-6">
            <form id="searchForm" class="d-flex">
              <input type="text" name="search" class="form-control" 
                     placeholder="Cari judul regulasi dinamis" 
                     value="{{ $search ?? '' }}">
        ...
        <div class="table-responsive" id="table-container">
          @include('AdminWeb.InformasiPublik.RegulasiDinamis.data')
        </div>
      </div>
  </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#searchForm').on('submit', function(e) {
        ...
        loadRegulasiDinamisData(1, search);
      });
      ...
      $(document).on('click', '.pagination a', function(e) {
        ...
        loadRegulasiDinamisData(page, search);
      });
    });
    
    function loadRegulasiDinamisData(page, search) {
      $.ajax({
        url: '{{ url("adminweb/informasipublik/regulasi-dinamis/getData") }}',
        type: 'GET',
        data: {
          page: page,
          search: search
    ...
    function reloadTable() {
      ...
      var search = $('#searchForm input[name="search"]').val();
      loadRegulasiDinamisData(currentPage, search);
    }
  </script>
@endpush
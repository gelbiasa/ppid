...
<div class="modal-header">
 ...
 <div class="modal-body">    
     <div class="alert alert-danger mt-3">
         <i class="fas fa-exclamation-triangle mr-2"></i> Menghapus berita dinamis ini akan berpengaruh pada data terkait.
         Apakah Anda yakin ingin menghapus berita dinamis dengan detail berikut:
     </div>

      ...
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ url('adminweb/pintasan-lainnya/addData') }}')" 
  ...
  <script>
    $(document).ready(function() {
      $('#searchForm').on('submit', function(e) {
        ...
        loadPintasanLainnyaData(1, search);
      });
      ...
      $(document).on('click', '.pagination a', function(e) {
        ...
        loadPintasanLainnyaData(page, search);
      });
    });
    
    function loadPintasanLainnyaData(page, search) {
      $.ajax({
        url: '{{ url("adminweb/pintasan-lainnya/getData") }}',
        type: 'GET',
        data: {
          page: page,
          search: search
    ...
    function reloadTable() {
      ...
      var search = $('#searchForm input[name="search"]').val();
      loadPintasanLainnyaData(currentPage, search);
    }
  </script>
@endpush
         ...
         <tr>
             ...
             <td>
                @if(
                    ...
                    HakAksesModel::cekHakAkses(Auth::user()->user_id, $detailPintasanLainnyaUrl, 'update')
                )
                ...
                @if(
                    Auth::user()->level->level_kode === 'SAR' ||
                    HakAksesModel::cekHakAkses(Auth::user()->user_id, $detailPintasanLainnyaUrl, 'delete')
                )

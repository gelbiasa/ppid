   ...
   <div class="modal-body">
     <form id="formUpdateDetailPintasanLainnya" action="{{ url('adminweb/DetailPintasanLainnya/updateData/'.$detailPintasanLainnya->detail_pintasan_lainnya_id) }}" method="POST">
         ...
         <div class="form-group">
             ...
             <select class="form-control" id="fk_pintasan_lainnya" name="t_detail_pintasan_lainnya[fk_pintasan_lainnya]">
                 ...
                 @foreach ($pintasanLainnya as $pintasan)
                     <option value="{{ $pintasan->pintasan_lainnya_id }}" {{ $detailPintasanLainnya->fk_pintasan_lainnya == $pintasan->pintasan_lainnya_id ? 'selected' : '' }}>
                         {{ $pintasan->tpl_nama_kategori }}
                     </option>
                 @endforeach
             </select>
         ...
         <div class="form-group">
             ...
             <input type="text" class="form-control" id="dpl_judul" name="t_detail_pintasan_lainnya[dpl_judul]" maxlength="100" value="{{ $detailPintasanLainnya->dpl_judul }}" placeholder="Masukkan judul pintasan">
             <div class="invalid-feedback" id="dpl_judul_error"></div>
         </div>
   
         <div class="form-group">
             <label for="dpl_url">URL Pintasan <span class="text-danger">*</span></label>
             <input type="text" class="form-control" id="dpl_url" name="t_detail_pintasan_lainnya[dpl_url]" maxlength="100" value="{{ $detailPintasanLainnya->dpl_url }}" placeholder="Masukkan URL pintasan (contoh: https://example.com)">
   ...
   <script>
     $(document).ready(function () {
         ...
         $('#btnSubmitForm').on('click', function() {
             ...
             const form = $('#formUpdateDetailPintasanLainnya');

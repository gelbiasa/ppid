                ...
                <div class="col-md-6 text-right">
                    <div class="card-tools">
                        ...
                        @if(
                          ...
                          SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $detailBeritaUrl, 'create')
                          )
                          <button onclick="modalAction('{{ url($detailBeritaUrl . '/addData') }}')" class="btn btn-sm btn-success">
...
<script>
    ...
    // URL dinamis untuk Management detailBerita
    var detailBeritaUrl = '{{ $detailBeritaUrl }}';
    ...
    function loadBeritaData(page, search) {
      $.ajax({
      url: '{{ url('') }}/' + detailBeritaUrl + '/getData',
      type: 'GET',
      data: {
        page: page,
        search: search

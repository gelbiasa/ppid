        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-right">
                    <button onclick="modalAction('{{ url('adminweb/berita/addData') }}')" class="btn btn-sm btn-success">
...
@push('js')
<script>
    // Tambahkan setup AJAX CSRF Token
    $.ajaxSetup({
        headers: {
    ...
    function modalAction(url) {
        console.log('Modal Action URL:', url);  // Tambahkan logging
                ...
                $('#myModal .modal-content').html(`
                    ...
                    <div class="modal-body">
                        <div class="alert alert-danger">
                            ...
                            (Status: ${xhr.status}, Pesan: ${xhr.statusText})
                        </div>
                    </div>
                `);
            }

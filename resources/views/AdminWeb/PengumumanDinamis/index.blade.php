  ...
  <div class="card card-outline card-primary">
      <div class="card-header">
        ...
        <div class="card-tools">
          <button onclick="modalAction('{{ url('adminweb/PengumumanDinamis/addData') }}')" class="btn btn-sm btn-success mt-1">
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover table-sm" id="table_pengumuman_dinamis">
              <thead>
                  <tr>
                      <th width="5%">Nomor</th>
...
@push('js')
  <script>
    $(document).ready(function() {
      ...
      $('#table_pengumuman_dinamis').DataTable({
        processing: true,
        serverSide: false,
        ajax: {
        ...
        columns: [
          { data: 0 }, // Nomor
          { data: 1 }, // Nama Submenu Pengumuman

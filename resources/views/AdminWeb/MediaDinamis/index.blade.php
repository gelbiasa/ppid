      ...
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ url('adminweb/media-dinamis/addData') }}')" 
          ...
          <div class="col-md-6">
            <form id="searchForm" class="d-flex">
              <input type="text" name="search" class="form-control" 
                     placeholder="Cari kategori media" 
                     value="{{ $search ?? '' }}">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.pagination a', function(e) {
        ...
        loadMediaDinamisData(page, search);
      });
    });
    
    function loadMediaDinamisData(page, search) {
      $.ajax({
        url: '{{ url("adminweb/media-dinamis/getData") }}',
        type: 'GET',
        data: {
          page: page,
          search: search
    ...
    function reloadTable() {
      ...
      var search = $('#searchForm input[name="search"]').val();
      loadMediaDinamisData(currentPage, search);
    }
  </script>
@endpush
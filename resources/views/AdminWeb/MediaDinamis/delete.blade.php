<div class="modal-header">
 ...
 <div class="modal-body">    
     <div class="alert alert-danger mt-3">
         <i class="fas fa-exclamation-triangle mr-2"></i> Menghapus media dinamis ini akan berpengaruh pada data terkait.
         Apakah Anda yakin ingin menghapus media dinamis dengan detail berikut:
     </div>
         ...
         <div class="card-body">
             <table class="table table-borderless">
                 ...
                 <tr>
                     ...
                     <td>{{ date('d-m-Y H:i:s', strtotime($mediaDinamis->created_at)) }}</td>
                 </tr>
                 <tr>
                     <th>Dibuat Oleh</th>
                     <td>{{ $mediaDinamis->created_by }}</td>
                 </tr>
                 @if($mediaDinamis->updated_by)
                 <tr>
                     <th>Terakhir Diperbarui</th>
                     <td>{{ date('d-m-Y H:i:s', strtotime($mediaDinamis->updated_at)) }}</td>
                 </tr>
                 <tr>

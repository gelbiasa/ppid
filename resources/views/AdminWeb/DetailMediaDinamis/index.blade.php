@php
  ...
  $detailMediaUrl = WebMenuModel::getDynamicMenuUrl('detail-media');
@endphp
          ...
          <div class="col-md-6 text-right">
            <div class="card-tools">
              ...
              @if(
                ...
                SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $detailMediaUrl, 'create')
                )
                <button onclick="modalAction('{{ url($detailMediaUrl . '/addData') }}')" class="btn btn-sm btn-success">
...
<script>
  ...
  // URL dinamis untuk Management detailMedia
  var detailMediaUrl = '{{ $detailMediaUrl }}';
  ...
  // Fungsi untuk memuat data detailMedia
  function loadDetailMediaData(page, search) {
    $.ajax({
    url: '{{ url('') }}/' + detailMediaUrl + '/getData',
    type: 'GET',
    data: {
      page: page,
      search: search

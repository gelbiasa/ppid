  ...
  <div class="card card-outline card-primary">
          ...
          <div class="col-md-6 text-right">
            <div class="card-tools">
              ...
              @if(
                ...
                HakAksesModel::cekHakAkses(Auth::user()->user_id, $kategoriAksesCepatUrl, 'create')
                )
      ...
      <div class="card-body">
        ...
        <div class="table-responsive" id="table-container">
          @include('AdminWeb.KategoriAkses.data')
        </div>
      </div>
  </div>
...
<script>
  ...
  // URL dinamis untuk Management kategoriAksesCepat
  var kategoriAksesCepatUrl = '{{ $kategoriAksesCepatUrl }}';

  // Handle search form submission
  $('#searchForm').on('submit', function (e) {
    e.preventDefault();
    var search = $(this).find('input[name="search"]').val();
    loadKategoriAksesCepatData(1, search);
  });
  ...
  $(document).on('click', '.pagination a', function (e) {
    ...
    loadKategoriAksesCepatData(page, search);
  });

  // Fungsi untuk memuat data kategoriAksesCepat
  function loadKategoriAksesCepatData(page, search) {
    $.ajax({
    url: '{{ url('') }}/' + kategoriAksesCepatUrl + '/getData',
    type: 'GET',
    data: {
      page: page,
      search: search
  ...
  function reloadTable() {
    ...
    var search = $('#searchForm input[name="search"]').val();
    loadKategoriAksesCepatData(currentPage, search);
  }

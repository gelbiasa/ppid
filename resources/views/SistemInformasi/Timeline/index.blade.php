  ...
  <div class="card card-outline card-primary">
      <div class="card-header">
        ...
        <div class="card-tools">
          <button onclick="modalAction('{{ url('SistemInformasi/Timeline/addData') }}')" class="btn btn-sm btn-success mt-1">
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover table-sm" id="table_timeline">
              <thead>
                  <tr>
                      <th width="5%">Nomor</th>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#table_timeline').DataTable({
        ...
        serverSide: false,
        ajax: {
          url: '{{ url("SistemInformasi/Timeline/getData") }}',
          type: 'GET',
        },
        columns: [
          { data: 0 }, // Nomor
          { data: 1 }, // Kategori Timeline
          { data: 2 }, // Judul Timeline

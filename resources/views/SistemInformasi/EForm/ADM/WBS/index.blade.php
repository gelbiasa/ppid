...
$data = app()->call([app('App\Http\Controllers\SistemInformasi\EForm\WBSController'), 'getData']);
            ...
            <div class="col-md-4">
                <div class="card-tools">
                    @if(
                      ...
                      SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $wbsAdminUrl, 'create')
                    )
                    <a href="{{ url($wbsAdminUrl . '/addData') }}" class="custom-button d-block p-3 mb-2">

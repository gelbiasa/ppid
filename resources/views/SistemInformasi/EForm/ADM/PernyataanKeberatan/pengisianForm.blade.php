...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <div>
                <a href="{{ url('SistemInformasi/EForm/ADM/PernyataanKeberatan') }}" class="btn btn-secondary">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('SistemInformasi/EForm/ADM/PernyataanKeberatan/createData') }}" method="POST"

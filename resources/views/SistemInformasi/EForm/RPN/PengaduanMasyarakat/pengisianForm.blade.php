...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <div>
                <a href="{{ url('SistemInformasi/EForm/RPN/PengaduanMasyarakat') }}" class="btn btn-secondary">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('SistemInformasi/EForm/RPN/PengaduanMasyarakat/createData') }}" method="POST"

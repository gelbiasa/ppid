@php
  ...
  $pengaduanMasyarakatRespondenUrl = WebMenuModel::getDynamicMenuUrl('pengaduan-masyarakat');
@endphp
...
$data = app()->call([app('App\Http\Controllers\SistemInformasi\EForm\PengaduanMasyarakatController'), 'getData']);
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            ...
            @else
                Prosedur Pengajuan Pengaduan Masyarakat
            @endif
        </h3>
    </div>
    ...
    <div class="card-header text-center">
        <h3 class="card-title font-weight-bold" style="float: none; display: inline-block;">
            ...
            @else
                Ketentuan Pelaporan Pengaduan Masyarakat
            @endif
        </h3>
    </div>
    ...
    <div class="card-body" style="padding-top: 10px;">
        <hr class="thick-line">
        <h4><strong>Silakan laporkan pengaduan Anda melalui form berikut</strong></h4>
        <hr class="thick-line">
        <div class="row text-center">
            <div class="col-md-4">
                <a href="{{ url($pengaduanMasyarakatRespondenUrl . '/addData') }}" class="custom-button d-block p-3 mb-2">

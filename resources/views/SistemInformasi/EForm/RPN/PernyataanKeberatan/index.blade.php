@php
  ...
  $pernyataanKeberatanRespondenUrl = WebMenuModel::getDynamicMenuUrl('pernyataan-keberatan');
@endphp
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            ...
            @else
                Prosedur Pengajuan Pernyataan Keberatan
            @endif
        </h3>
    </div>
    <div class="card-body" style="margin-bottom: 0; padding-bottom: 0;">
        <p>Ikuti langkah-langkah berikut untuk mengajukan Pernyataan Keberatan:</p>
    ...
    <div class="card-header text-center">
        <h3 class="card-title font-weight-bold" style="float: none; display: inline-block;">
            ...
            @else
                Ketentuan Pelaporan Pernyataan Keberatan
            @endif
        </h3>
    </div>
    ...
    <div class="card-body" style="padding-top: 10px;">
        <hr class="thick-line">
        <h4><strong>Silakan laporkan Pernyataan Keberatan Anda melalui form berikut</strong></h4>
        <hr class="thick-line">
        <div class="row text-center">
            <div class="col-md-4">
                <a href="{{ url($pernyataanKeberatanRespondenUrl . '/addData') }}" class="custom-button d-block p-3 mb-2">

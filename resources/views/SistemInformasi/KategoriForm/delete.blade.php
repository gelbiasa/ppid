<div class="modal-header">
  ...
  <div class="modal-body">    
    <div class="alert alert-danger mt-3">
      <i class="fas fa-exclamation-triangle mr-2"></i> Apakah Anda yakin ingin menghapus kategori form dengan detail berikut:
    </div>
    ...
    <div class="alert alert-warning mt-3">
      <i class="fas fa-info-circle mr-2"></i> <strong>Perhatian:</strong> Menghapus kategori form ini mungkin akan memengaruhi timeline atau data lain yang terkait dengannya. Pastikan tidak ada timeline atau data lain yang masih menggunakan kategori form ini.
    </div>
  </div>
  ...
  <div class="modal-footer">
    ...
    <button type="button" class="btn btn-danger" id="confirmDeleteButton" 
      onclick="confirmDelete('{{ url('SistemInformasi/KategoriForm/deleteData/'.$kategoriForm->kategori_form_id) }}')">
